#!/usr/bin/env python
# -*- coding: utf-8 -*-  
# by zhangzhi @2013-11-15 23:07:37 
# Copyright 2013 NONE rights reserved.
# thks for web's codes
import pandas
import pylab
...
class ProbabilisticMatrixFactorization():
    ...
    * save_latent_vectors
    ...
    def __init__(self, rating_df, latent_d=1, verbose=True):
        ...
        self.learning_rate = .0001 # alpha, update automatically 
        self.regularization_strength = 0.1 # lambda, is ok to be the same
    ...
    def update(self):
        ...
        while (not self.converged):
            ...
            lRates.append(self.learning_rate)
    ...
    def predict(self, i, j):
        # predict the entry: i, j
        return numpy.sum(self.users[i] * self.items[j])
...
if __name__ == "__main__":
    ...
    pmf = ProbabilisticMatrixFactorization(ratings, latent_d=5, verbose=False)
    
    liks, lRates = pmf.update()
    print "try predict:"
    print ratings
    #print pmf.predict(ratings[0][0], ratings[0][1])
